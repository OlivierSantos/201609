		...
		<div class="container" >
			<div class="page-header">
				<div class="container" style="margin-top:40px;">
					...
					<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<p style="font-size:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit Your Hospital Info Here.</p>
				</div>
			</div>
			<br><br>
			<div class="row" >
				<div class="col-sm-8 col-sm-offset-2" >
					<form id="defaultForm" method="post" class="form-horizontal" action="receptionistPanel.php" enctype="multipart/form-data"  >
						<div class="form-group">
							<label class="col-sm-3 control-label" style="text-align:left;">Hospital Name</label>
							<div class="col-sm-5">
							<input type="text" class="form-control" rows="3" name="name"
											required data-fv-notempty-message="First name" placeholder="Hospital Name" maxlength="75" ></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" style="text-align:left;">Hospital Description</label>
							<div class="col-sm-5">
							<textarea class="form-control" rows="3" name="desc"
											required data-fv-notempty-message="First name" placeholder="Hospital description" maxlength="75"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" style="text-align:left;">Specialities</label>
							<div class="col-sm-5">
						    <input type="checkbox" name="speciality" style="width=2px; height:2px;">Eyes
							<input type="checkbox" class="form-control" name="speciality" >Pediatry
							<input type="checkbox" class="form-control" name="speciality">Eyes
							<input type="checkbox" class="form-control" name="speciality" >Pediatry<br>
							<input type="checkbox" class="form-control" name="speciality" >Eyes<br>
							<input type="checkbox" class="form-control" name="speciality">Pediatry<br>
							<input type="checkbox" class="form-control" name="speciality" >Eyes<br>
							<input type="checkbox" class="form-control" name="speciality" >Pediatry<br>
							<input type="checkbox" class="form-control" name="speciality" >Eyes
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" style="text-align:left;">Hospital Image</label>
							<div class="col-sm-5">
							<input type="file" name="img"
											required data-fv-notempty-message="First name" placeholder="image" maxlength="75"></textarea>
							</div>
						</div>
							<br>
							<div class="form-group">
